#!/usr/bin/env python3
"""MM benchmark with per-problem timeouts."""
import os, time, sys, signal, numpy as np, cvxpy as cp
...
print(f'Testing {len(files)} problems (max n={MAX_N}, max_iter={MAX_ITERS}, timeout={TIMEOUT}s)')
